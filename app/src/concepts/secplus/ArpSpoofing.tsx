  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-slate-100">ARP Spoofing &amp; the On-Path Attack</h3>
          <p className="text-sm text-slate-400">Domain 2.4 — see how a poisoned ARP cache redirects traffic.</p>
        </div>
        <button
          onClick={() => {
      ...
      {/* Network diagram */}
      <div className="relative rounded-xl border border-slate-800 bg-slate-900 p-8 min-h-[220px]">
        <svg viewBox="0 0 600 200" className="w-full h-48" aria-hidden>
          {/* victim */}
          <g transform="translate(40,80)">
            <rect width="90" height="50" rx="8" className="fill-sky-900 stroke-sky-500" strokeWidth="1.5" />
            <text x="45" y="30" textAnchor="middle" className="fill-sky-200 text-[13px] font-medium">
              Victim
            </text>
          </g>
          ...
          <g transform="translate(470,20)">
            <rect width="90" height="50" rx="8" className="fill-emerald-900 stroke-emerald-500" strokeWidth="1.5" />
            <text x="45" y="30" textAnchor="middle" className="fill-emerald-200 text-[13px] font-medium">
              Gateway
            </text>
          </g>
          ...
          <g transform="translate(470,130)">
            <rect
              ...
              height="50"
              rx="8"
              className={`stroke-red-500 transition-colors duration-700 ${poisoned ? 'fill-red-900' : 'fill-slate-800'}`}
              strokeWidth="1.5"
            />
            <text x="45" y="30" textAnchor="middle" className="fill-red-200 text-[13px] font-medium">
              Attacker
            </text>
          </g>
          ...
          <line
            ...
            x2="470"
            y2="45"
            className={`stroke-emerald-500 transition-opacity duration-700 ${phase === 0 ? 'opacity-100' : 'opacity-0'}`}
            strokeWidth="2.5"
          ...
          <line
            ...
            x2="130"
            y2="105"
            className={`stroke-red-500 transition-opacity duration-700 ${phase === 1 ? 'opacity-100' : 'opacity-0'}`}
            strokeWidth="2"
            strokeDasharray="6 4"
          ...
          <line
            ...
            x2="470"
            y2="155"
            className={`stroke-red-500 transition-opacity duration-700 ${poisoned ? 'opacity-100' : 'opacity-0'}`}
            strokeWidth="2.5"
            markerEnd="url(#arrowRed)"
          />
          <line
            ...
            x2="560"
            y2="70"
            className={`stroke-red-500 transition-opacity duration-700 ${intercepting ? 'opacity-100' : 'opacity-0'}`}
            strokeWidth="2"
            strokeDasharray="4 3"
          />
          <line
            ...
            x2="500"
            y2="60"
            className={`stroke-emerald-500 transition-opacity duration-700 ${intercepting ? 'opacity-100' : 'opacity-0'}`}
            strokeWidth="2"
            markerEnd="url(#arrowGreen)"
          />
        ...
        {poisoned && (
          <p className="text-center text-xs text-red-300 font-medium -mt-2">
      ...
      <div className="flex gap-2">
        {PHASES.map((p, i) => (
          <button
            ...
            className={`flex-1 rounded-md px-2 py-1.5 text-[11px] font-medium transition-colors border ${
              i === phase
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 text-sm text-slate-300 leading-relaxed">
        {PHASES[phase].caption}
      </div>

      <div className="rounded-lg border border-slate-800 bg-slate-900/60 p-4 text-sm">
        <p className="font-semibold text-slate-200 mb-1">Why it works</p>
