...
export default function WirelessSecurityArchitecture() {
  ...
  return (
    <div className="space-y-5">
      ...
      <input type="range" aria-label="Wireless Security Standards" min={0} max={TIERS.length - 1} step={1} value={selected} onChange={(e) => setSelected(Number(e.target.value))} className="w-full" />
